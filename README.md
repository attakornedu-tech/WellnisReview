...
ต่อการเรียก 1 ครั้ง (ไม่มีการแบ่งหน้า/pagination) ระบบนี้จึงนับ "รีวิวใหม่วันนี้" โดยเทียบ**วันที่โพสต์จริงของแต่ละรีวิว**
กับวันที่ปัจจุบัน (เขตเวลา Asia/Bangkok) ไม่ใช่การจำว่าเคยเห็นรีวิวนั้นมาก่อนหรือยัง — ดังนั้นตัวเลขจะแม่นยำ
**ตราบใดที่สาขานั้นไม่ได้รับรีวิวใหม่เกิน 5 รายการในวันเดียว** (กรณีปกติของคลินิกไม่น่าเกิน)
